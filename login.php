					...
					<div class="collapse">
						<ul>
							...
							if (!isset($_SESSION['nome'])){
								?>
								<li><a href="cadastro.php" class="buton" ><b class="cor_cadas">Cadastrar</b></a></li>	
								<?php
							}else{
								?>
				...
				<div class="content">
					<div class="row">
						<div class="column column-4">	
							<br><br>
							<h1 class="text_grande">FAÇA LOGIN E VAMOS COMEÇAR!</h1>
							<br>
						</div>
						<div class="column column-3" style="background: #fff;height: 350px;border-radius: 10px;padding: 10px 25px">
							<form name="form" method="post" action="sys/login_user.php">
								<h1 class="text" style="color:#000">Faça Seu Login</h1>
								...
								<button class="btn btn-messenger" class="buton" style="width: 50%;margin-top: 5px;border-radius: 10px;float:left">Entrar</button>
								<br><br><br><br><br>
								<a style="color:#000;font-size: 12px;float: left">Não possuo cadastro,<a href="cadastro.php" style="color:#12bbac;font-size: 12px;float: left;margin-left: 5px">Quero criar minha conta</a>.</a>
							</form>
						</div>
